  ...
  themes: {
    space: {
      ...
      titles: [
        ...
        'Fix Telescope',
        'Track Satellites',
        'Plan ISS Maintenance Schedule for Q2',
        'Analyze Recent Asteroid Samples',
        'Update Mission Control Systems',
        'Test New Space Suits',
        'Map Galaxies',
        'Scout Moon',
        'Design Habitat for Mars Colony',
        'Plot Course',
        'Research Advanced Propulsion Methods',
        'Check Life Support',
        'Log Signals',
        'Train Crew',
        'Test Zero-G',
        'Monitor Solar Activity Patterns',
        'Deploy Probe',
        'Plan Mission'
      ]
    },
    tech: {
      ...
      titles: [
        ...
        'Ship Features',
        'Update Docs',
        'Configure Production Server Cluster',
        'Train AI',
        'Speed Up App',
        ...
        'Monitor Health',
        'Backup Data',
        'Evaluate New Tech Stack Options',
        'Deploy Code',
        'Check Logs'
      ]
    },
